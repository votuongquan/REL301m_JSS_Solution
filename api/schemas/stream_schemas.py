...
StreamEvent = Union[ConnectionEstablishedEvent, SessionCreatedEvent, SessionStatusUpdateEvent, ComparisonStartEvent, ComparisonProgressEvent, ComparisonCompleteEvent, MethodStartEvent, MethodCompleteEvent, EpisodeStartEvent, EpisodeProgressEvent, EpisodeCompleteEvent, ErrorEvent]
