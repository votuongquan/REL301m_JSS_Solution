...
class StreamManager:
    ...
    async def subscribe_to_session(self, client_id: str, session_id: str) -> bool:
        ...
        await self.connections[client_id].send_message({
    ...
    async def send_episode_progress(self, session_id: str, episode: int, agent_name: str, 
                                  step: int, action: int, reward: float, makespan: float = None):
    ...
    async def send_episode_complete(self, session_id: str, episode: int, agent_name: str,
                                  makespan: float, total_reward: float, execution_time: float):
    ...
    async def send_comparison_progress(self, session_id: str, completed_agents: int, 
                                     total_agents: int, current_agent: str = None):
